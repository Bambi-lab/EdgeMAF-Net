...
def select_device(device="", batch=0, newline=False, verbose=True):
    ...
    s = f"EdgeMAF-Net v{__version__} 🚀 Python-{PYTHON_VERSION} torch-{torch.__version__} "
...
def init_seeds(seed=0, deterministic=False):
    ...
    torch.backends.cudnn.benchmark = False  # AutoBatch problem https://github.com/ultralytics/yolov5/issues/9287
    if deterministic:
        if TORCH_2_0:
        ...
        LOGGER.warning("deterministic training....")
    else:
